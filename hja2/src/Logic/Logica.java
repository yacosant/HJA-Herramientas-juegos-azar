...
public class Logica {
    ...
    public static void pulsacion(String s) {
        ...
        a = Logica.CharToInt(s.charAt(i));
        b = Logica.CharToInt(s.charAt(i + 1));
        if (s.length() == 3) {
            c = s.charAt(2);
    ...
    public static String porcentajeString() {
        return String.valueOf(redondear(Logica.porcentaje, 2));
    }
    ...
    public static void pintarPor(double valor, Tablero t2) {
        ...
        while (valor > 0 && i < ranking.length) {
            ...
            valor = Logica.restarPorcentaje(valor, x, y);
    ...
    private static void delCartas(Posicion p) {
        ...
        while (!encontrado && i < rango.size()) {
            if (rango.get(i).getX() == p.getX() && rango.get(i).getY() == p.getY()) {
                encontrado = true;
            }
            i++;
        }
    ...
    public static void delBoard(Carta c) {
        ...
        while (!encontrado && i < board.size()) {
            if (board.get(i).getColor() == c.getColor() && board.get(i).getValor() == c.getValor()) {
                encontrado = true;
            }
            i++;
        }
        ...
        Collections.sort(pos, new Comparator<Posicion>() {
            public int compare(Posicion p1, Posicion p2) {
                ...
                if (a == b) {
                    ...
                    return new Integer(p2.getY()).compareTo(new Integer(p1.getY()));
                }
            }
        });
    }
        ...
        Collections.sort(pair, new Comparator<Posicion>() {
            public int compare(Posicion p1, Posicion p2) {
                ...
                if (a == b) {
                    ...
                    return new Integer(p2.getX()).compareTo(new Integer(p1.getX()));
                }
            }
        });
    }
